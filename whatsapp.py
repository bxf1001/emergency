...
import keyboard
from pywinauto import Application, base_wrapper
...
class WhatsApp:
    ...
    def start_recording(self):
        ...
        #for _   in range(10):
            #try:
        self.panel =self.dialog.child_window(title="Device settings", auto_id="MoreButton", control_type="Button").wait('visible',timeout=60,retry_interval=0.5)
